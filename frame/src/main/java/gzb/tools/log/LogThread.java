...
public class LogThread {
    ...
    public static String[] lvNames = new String[]{"debug", "info ", "warn ", "error"};
    public static Queue<String>[] logQueues = new Queue[]{null, null, null, null};
    public static File[] logFile = new File[]{null, null, null, null};
    public static Integer[] lvConfig = new Integer[]{0,0,0,0};
    public static String[] lvColour = new String[]{"\u001B[32m", "\u001B[94m", "\u001B[33m", "\u001B[31m", "\u001B[0m"};
    ...
    public void addLog(int index, Class aClass, Object[] log) {
        ...
        if (configValue == 0 || configValue == 3){
            System.out.println(lvColour[index]+msg+lvColour[4]);
        }
