...
public class JSONResult {
    ...
    public JSONResult initJson(Integer state, String message, String stringData, List<?> data, String jump, Integer page, Integer size, Integer total) {
        json.put(codeText, state);
        json.put(messageText, message);
        if (stringData == null) {
            json.put(dataText, data);
        } else {
            json.put(dataText, stringData);
        }
        json.put(jumpText, jump);
        json.put(pageText, page);
        json.put(sizeText, size);
        json.put(totalText, total);
        json.put(timeText, System.currentTimeMillis());
        return this;
    }

    public <T> List<T> getList() {
        return json.getList(dataText);
    }

    public Map<String, Object> getMap() {
        return json.getMap(dataText);
    }
    ...
    public JSONResult _success() {
        json.put(codeText, codeSuccess);
        return this;
    }

    public JSONResult _fail() {
        json.put(codeText, codeFail);
        return this;
    }

    public JSONResult _err() {
        json.put(codeText, codeError);
        return this;
    }

    public JSONResult _jump() {
        json.put(codeText, codeJump);
        return this;
    }

    public JSONResult _jump(String url) {
        json.put(codeText, codeJump);
        json.put(jumpText, url);
        return this;
    }
