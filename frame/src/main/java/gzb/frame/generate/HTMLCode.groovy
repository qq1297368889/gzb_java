...
class HTMLCode extends Base {
    ...
    public void start(List<TableInfo> list, boolean save) {
        ...
        for (final def tableInfo in list) {
            gen_jsCode(tableInfo.nameHumpLowerCase,tableInfo.idHumpLowerCase);
        }
    ...
    public void gen_index_html(){
        String code ="<!DOCTYPE html>\n" +
                ...
                "                        <!-- <dd layadmin-event=\"logout\" style=\"text-align: center;\"><a href=\"login.html\">退出登录</a></dd>-->\n" +
                "                    </dl>\n" +
                "                </li>\n" +
    ...
    public void gen_jsCode(name,id){
