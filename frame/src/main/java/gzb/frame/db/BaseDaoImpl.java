...
public abstract class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    private final Log log = Config.log;
    ...
    public int executeBatch(String sql, List<Object[]> params) throws Exception {
        return executeBatch(sql, params, params.size());
    }
    ...
    @Override
    public List<T> queryCache(String sql, Object[] params, String sortField, String sortType, int page, int size, int second) {
        if (t == null) {
            return null;
        }
        String pageSql = sql.toLowerCase();
    ...
    @Override
    public List<T> queryCache(T t, int second) throws Exception {
        if (t == null) {
            return null;
        }
        SqlTemplate sqlTemplate = ClassTools.toSelectSql(t);
    ...
    @Override
    public List<T> queryCache(T t, String sortField, String sortType, int page, int size, int second) throws Exception {
        if (t == null) {
            return null;
        }
        SqlTemplate sqlTemplate = ClassTools.toSelectSql(t);
    ...
    @Override
    public JSONResult queryPageCache(T t, String sortField, String sortType, Integer page, Integer size, int maxPage, int maxSize, int second) throws Exception {
        if (t == null) {
            return null;
        }
        SqlTemplate sqlTemplate = ClassTools.toSelectSql(t);
