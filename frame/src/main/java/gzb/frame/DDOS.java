...
public class DDOS {
    ...
    public static void start(String name,int threadNum,String requestUrl,int requestMet,String requestData,int requestNum,byte[] successData) {
        ...
        System.out.println("任务名称 "+name + " 线程数量 "+threadNum+ " 压测总次数 "+requestNum
                +" url " + requestUrl + " met " + requestMet + " data " + requestData
        ...
        for (int i = 0; i < threadNum; i++) {
            ...
            new Thread() {
                ...
                public void run() {
                    HTTP http = new HTTP();
                    byte[] bytes = http.request(requestUrl,requestData,requestMet).toByte();
                    ...
                    for (int i1 = 0; i1 < requestNum; i1++) {
                        ...
                        bytes = http.request(requestUrl,requestData,requestMet).toByte();
