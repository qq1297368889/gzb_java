...
public class SysPermissionController{
    ...
    public Object query(GzbJson result, String[] field, String[] symbol, String[] value, String[] montage, String sortField, String sortType, Integer page, Integer limit) throws Exception {
        SqlTemplate sqlTemplate = sysPermissionDao.getDataBase().toSelect("sys_permission", field, symbol, value, montage, null, null);
    ...
    public Object deleteAll(GzbJson result, java.lang.Long[] sysPermissionId) throws Exception {
        if (sysPermissionId == null || sysPermissionId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num = 0;
        SysPermission frame = new SysPermission();
        for (java.lang.Long _id : sysPermissionId) {
            sysPermissionDao.delete(frame.setSysPermissionId(_id));
            num++;
        }
