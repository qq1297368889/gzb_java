...
@RequestMapping(value = "/system/v1.0.0/sysLog")
public class SysLogController{
    ...
    /**
     * 查询,不能接受空数据,请至少提供一个参数,请提供 SysLog的参数 
     * /system/v1.0.0/sysLog/find?参数同下,只是仅接受查询结果为1条的情况
     * */
    @DecoratorOpen
    @GetMapping(value = "find")
    public Object find(GzbJson result, SysLog sysLog) throws Exception {
        ...
        return result.success("查询成功",sysLog1);
    }
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(GzbJson result,SysLog sysLog, String sortField, String sortType, Integer page, Integer size) throws Exception {
        if(sysLog == null){
           sysLog = new SysLog();
        }
    ...
    public Object query(GzbJson result, String[] field, String[] symbol, String[] value, String[] montage, String sortField, String sortType, Integer page, Integer limit) throws Exception {
        SqlTemplate sqlTemplate = sysLogDao.getDataBase().toSelect("sys_log", field, symbol, value, montage, null, null);
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(GzbJson result, SysLog sysLog) throws Exception {
        if (sysLog == null || sysLog.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(GzbJson result, SysLog sysLog) throws Exception {
    ...
    public Object delete(GzbJson result, SysLog sysLog) throws Exception {
        if (sysLog == null || sysLog.toString().equals("{}") || sysLog.getSysLogId() == null) {
    ...
    public Object deleteAll(GzbJson result, java.lang.Long[] sysLogId) throws Exception {
        if (sysLogId == null || sysLogId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num = 0;
        SysLog frame = new SysLog();
        for (java.lang.Long _id : sysLogId) {
            sysLogDao.delete(frame.setSysLogId(_id));
            num++;
        }
