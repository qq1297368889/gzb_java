...
@RequestMapping(value = "/system/v1.0.0/sysOption")
public class SysOptionController{
    @Resource(value = "com.frame.dao.impl.SysOptionDaoImpl")
    SysOptionDao sysOptionDao;
    @Resource(value = "gzb.tools.log.LogImpl")
    Log log;

    /**
     * 查询,不能接受空数据,请至少提供一个参数,请提供 SysOption的参数 
     * /system/v1.0.0/sysOption/find?参数同下,只是仅接受查询结果为1条的情况
     * */
    @DecoratorOpen
    @GetMapping(value = "find")
    public Object find(GzbJson result, SysOption sysOption) throws Exception {
        ...
        return result.success("查询成功",sysOption1);
    }
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(GzbJson result,SysOption sysOption, String sortField, String sortType, Integer page, Integer size) throws Exception {
        if(sysOption == null){
    ...
    /**
     * 查询,根据id修改其他参数 请提供 SysOption的参数 
    ...
    public Object query(GzbJson result, String[] field, String[] symbol, String[] value, String[] montage, String sortField, String sortType, Integer page, Integer limit) throws Exception {
        SqlTemplate sqlTemplate = sysOptionDao.getDataBase().toSelect("sys_option", field, symbol, value, montage, null, null);
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(GzbJson result, SysOption sysOption) throws Exception {
        if (sysOption == null || sysOption.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(GzbJson result, SysOption sysOption) throws Exception {
    ...
    public Object delete(GzbJson result, SysOption sysOption) throws Exception {
        if (sysOption == null || sysOption.toString().equals("{}") || sysOption.getSysOptionId() == null) {
    ...
    public Object deleteAll(GzbJson result, java.lang.Long[] sysOptionId) throws Exception {
        if (sysOptionId == null || sysOptionId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num = 0;
        SysOption frame = new SysOption();
        for (java.lang.Long _id : sysOptionId) {
            sysOptionDao.delete(frame.setSysOptionId(_id));
            num++;
        }
