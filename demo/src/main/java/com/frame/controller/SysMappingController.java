...
@RequestMapping(value = "/system/v1.0.0/sysMapping")
public class SysMappingController{
    ...
    /**
     * 查询,不能接受空数据,请至少提供一个参数,请提供 SysMapping的参数 
     * /system/v1.0.0/sysMapping/find?参数同下,只是仅接受查询结果为1条的情况
     * */
    @DecoratorOpen
    @GetMapping(value = "find")
    public Object find(GzbJson result, SysMapping sysMapping) throws Exception {
        ...
        return result.success("查询成功",sysMapping1);
    }
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(GzbJson result,SysMapping sysMapping, String sortField, String sortType, Integer page, Integer size) throws Exception {
        return sysMappingDao.queryPage(sysMapping, sortField, sortType, page, size, 100, 1000);
    }

    /**
     * 查询,根据id修改其他参数 请提供 SysMapping的参数 
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(GzbJson result, SysMapping sysMapping) throws Exception {
        if (sysMapping == null || sysMapping.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(GzbJson result, SysMapping sysMapping) throws Exception {
    ...
    public Object delete(GzbJson result, SysMapping sysMapping) throws Exception {
        if (sysMapping == null || sysMapping.toString().equals("{}") || sysMapping.getSysMappingId() == null) {
    ...
    public Object deleteAll(GzbJson result, Long[] sysMappingId) throws Exception {
