...
public class SystemAction {
    ...
    public Object readMapping(GzbJson res,Request request, String key,
        ...
        List<SysGroup> listSysGroup = sysGroupDao.query(new SysGroup().setSysGroupId(sysUsers.getSysUsersGroup()));
        ...
        for (SysGroupColumn sysGroupColumn : listSysGroupColumn) {
            //查询映射信息
            List<SysMapping> listSysMapping = sysMappingDao.query(new SysMapping().setSysMappingVal(sysGroupColumn.getSysGroupColumnName()).setSysMappingKey(key));
                ...
                for (SysMapping sysMapping : listSysMapping) {
                    ...
                    if (sysMappingSelect != null) {
                        ...
                        if (sysMappingSelect.startsWith("key:")) {
                            ...
                            listOption = sysOptionDao.query(sysMappingSelect, null);
                        }
    ...
    public Object upload(GzbJson res, FileUploadEntity[] file) throws Exception {
        if (file == null) {
    ...
    public Object readFile0(GzbJson res, SysFile sysFile, Boolean b64, Double t, Response response, Request request) throws Exception {
    ...
    public Object find(GzbJson result, SysUsers sysUsers0, Map<String, List<Object>> req) throws Exception {
        ...
        return result.success("查询成功", sysUsers1);
    }
