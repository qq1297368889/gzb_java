...
gzb.createFrom = function (col, type) {
    ...
    if (open == null || open.toString() != "1") {
        ...
        if (col.data.data.sysMappingColumnOption != null && col.data.data.sysMappingColumnOption.length > 0) {
            html += gzb.createSelectHTML(
                col.data.sysMappingColumnTitle,
                col.data.sysMappingColumnName,
                col.data.data.sysMappingColumnOption,
                null, def0, css);
            ...
            html += gzb.createTextareaHTML(
                ...
                null, def0, css);
        } else if (col.data.data.sysMappingColumnRequest != null) {
            ...
            gzb.registerEvent(id,function (){
                let req01=col.data.data.sysMappingColumnRequest;
...
gzb.initTable = function () {
    ...
    for (let res of gzb.mapping.data) {
        ...
        let _templet = null;
        let _is_select = res.data.data.sysMappingColumnOption;
        let _is_text = res.data.sysMappingColumnText;
        let req01=null;
        console.log(_field,res.data)
        if (res.data.data.sysMappingColumnRequest != null) {
            req01=res.data.data.sysMappingColumnRequest;
