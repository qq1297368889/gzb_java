...
layui.define("layer", function (e) {
    ...
    var d = function () {
        var e = null, a = f.config.verify, s = "layui-form-danger", o = {}, c = t(this), u = c.parents(r),
            d = u.find("*[lay-com.verify]"), v = c.parents("form")[0], h = c.attr("lay-filter");
        return layui.each(d, function (l, r) {
            var o = t(this), c = o.attr("lay-com.verify").split("|"), u = o.attr("lay-verType"), d = o.val();
