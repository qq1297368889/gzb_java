...
* 数组解析 ：这个情况比较复杂 它涉及到优势累加 还涉及到大响应的额外开销，并不容易准确计算。
...
* Array parsing: This case is more complex. It involves the accumulation of advantages and the additional overhead of large responses, and it is not easy to calculate accurately.

# 低压稳定性阶段  资源占用核心对比表 (20,000 QPS)
#### Quarkus 的延迟似乎异常高 可能是系统波动，可能无法代表
...
- This is only a partial description of the functionality. For details, please refer to the [open-source repository documentation](https://github.com/qq1297368889/gzb_java/blob/main/doc.md)
...
- Raw Netty (/text framework built-in) (QPS: 2.3 million+) The framework overhead is only < 10% reflected in the QPS
