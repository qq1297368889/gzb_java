...
public class SysRoleGroup implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_role_group_id",desc="",type="bigint")
    private Long sysRoleGroupId;
    @EntityAttribute(key=false,size = 0,name="sys_role_group_rid",desc="",type="bigint")
    private Long sysRoleGroupRid;
    @EntityAttribute(key=false,size = 0,name="sys_role_group_gid",desc="",type="bigint")
    private Long sysRoleGroupGid;
    private Object data;
   public SysRoleGroup() {}
    ...
    public SysRoleGroup setSysRoleGroupId(Long sysRoleGroupId) {
        this.sysRoleGroupId = sysRoleGroupId;
        return this;
    }
    public Long getSysRoleGroupRid() {
        return sysRoleGroupRid;
    }
    public SysRoleGroup setSysRoleGroupRid(Long sysRoleGroupRid) {
        this.sysRoleGroupRid = sysRoleGroupRid;
        return this;
    }
    public Long getSysRoleGroupGid() {
        return sysRoleGroupGid;
    }
    public SysRoleGroup setSysRoleGroupGid(Long sysRoleGroupGid) {
