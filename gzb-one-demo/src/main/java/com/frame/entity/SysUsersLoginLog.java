...
public class SysUsersLoginLog implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_users_login_log_id",desc="",type="bigint")
    private Long sysUsersLoginLogId;
    @EntityAttribute(key=false,size = 100,name="sys_users_login_log_ip",desc="",type="varchar(100)")
    private String sysUsersLoginLogIp;
    @EntityAttribute(key=false,size = 100,name="sys_users_login_log_desc",desc="",type="varchar(100)")
    private String sysUsersLoginLogDesc;
    @EntityAttribute(key=false,size = 0,name="sys_users_login_log_time",desc="",type="datetime")
    private java.time.LocalDateTime sysUsersLoginLogTime;
    @EntityAttribute(key=false,size = 0,name="sys_users_login_log_uid",desc="",type="bigint")
    private Long sysUsersLoginLogUid;
    @EntityAttribute(key=false,size = 100,name="sys_users_login_log_token",desc="",type="varchar(100)")
    private String sysUsersLoginLogToken;
    @EntityAttribute(key=false,size = 100,name="sys_users_login_log_mac",desc="",type="varchar(100)")
   ...
   public SysUsersLoginLog() {}
    ...
    public SysUsersLoginLog setSysUsersLoginLogIpUnsafe(String sysUsersLoginLogIp) {
        this.sysUsersLoginLogIp = sysUsersLoginLogIp;
        return this;
    }
    ...
    public SysUsersLoginLog setSysUsersLoginLogDescUnsafe(String sysUsersLoginLogDesc) {
        this.sysUsersLoginLogDesc = sysUsersLoginLogDesc;
        return this;
    }
    ...
    public SysUsersLoginLog setSysUsersLoginLogTokenUnsafe(String sysUsersLoginLogToken) {
        this.sysUsersLoginLogToken = sysUsersLoginLogToken;
        return this;
    }
    ...
    public SysUsersLoginLog setSysUsersLoginLogMacUnsafe(String sysUsersLoginLogMac) {
        this.sysUsersLoginLogMac = sysUsersLoginLogMac;
        return this;
    }
