...
public class SysRole implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_role_id",desc="",type="bigint")
    private Long sysRoleId;
    @EntityAttribute(key=false,size = 100,name="sys_role_name",desc="",type="varchar(100)")
    private String sysRoleName;
    @EntityAttribute(key=false,size = 0,name="sys_role_state",desc="",type="bigint")
    private Long sysRoleState;
    @EntityAttribute(key=false,size = 0,name="sys_role_time",desc="",type="datetime")
   ...
   public SysRole() {}
    ...
    public SysRole setSysRoleNameUnsafe(String sysRoleName) {
        this.sysRoleName = sysRoleName;
        return this;
    }
