...
public class SysOption implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_option_id",desc="选项id",type="bigint")
    private Long sysOptionId;
    @EntityAttribute(key=false,size = 100,name="sys_option_key",desc="选项名称",type="varchar(100)")
    private String sysOptionKey;
    @EntityAttribute(key=false,size = 255,name="sys_option_title",desc="选项标题",type="varchar(255)")
    private String sysOptionTitle;
    @EntityAttribute(key=false,size = 255,name="sys_option_value",desc="选项值",type="varchar(255)")
    private String sysOptionValue;
    @EntityAttribute(key=false,size = 0,name="sys_option_state",desc="选项状态",type="bigint")
    private Long sysOptionState;
    private Object data;
   public SysOption() {}
    ...
    public Long getSysOptionId() {
        return sysOptionId;
    }
    public SysOption setSysOptionId(Long sysOptionId) {
        this.sysOptionId = sysOptionId;
        return this;
    }
    public String getSysOptionKey() {
        return sysOptionKey;
    }
    public SysOption setSysOptionKey(String sysOptionKey) {
    ...
    public SysOption setSysOptionKeyUnsafe(String sysOptionKey) {
        this.sysOptionKey = sysOptionKey;
        return this;
    }
    public String getSysOptionTitle() {
        return sysOptionTitle;
    }
    public SysOption setSysOptionTitle(String sysOptionTitle) {
    ...
    public SysOption setSysOptionTitleUnsafe(String sysOptionTitle) {
        this.sysOptionTitle = sysOptionTitle;
        return this;
    }
    public String getSysOptionValue() {
        return sysOptionValue;
    }
    public SysOption setSysOptionValue(String sysOptionValue) {
    ...
    public SysOption setSysOptionValueUnsafe(String sysOptionValue) {
        this.sysOptionValue = sysOptionValue;
        return this;
    }
    public Long getSysOptionState() {
        return sysOptionState;
    }
    public SysOption setSysOptionState(Long sysOptionState) {
