...
public class SysPermission implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_permission_id",desc="权限名称",type="bigint")
    private Long sysPermissionId;
    @EntityAttribute(key=false,size = 255,name="sys_permission_name",desc="权限名称",type="varchar(255)")
    private String sysPermissionName;
    @EntityAttribute(key=false,size = 255,name="sys_permission_data",desc="权限数据",type="varchar(255)")
    private String sysPermissionData;
    @EntityAttribute(key=false,size = 0,name="sys_permission_type",desc="权限类型",type="bigint")
    private Long sysPermissionType;
    @EntityAttribute(key=false,size = 255,name="sys_permission_desc",desc="权限备注",type="varchar(255)")
    private String sysPermissionDesc;
    @EntityAttribute(key=false,size = 0,name="sys_permission_sup",desc="权限上级",type="bigint")
    private Long sysPermissionSup;
    @EntityAttribute(key=false,size = 0,name="sys_permission_sort",desc="权限排序",type="bigint")
   ...
   public SysPermission() {}
    ...
    public SysPermission setSysPermissionNameUnsafe(String sysPermissionName) {
        this.sysPermissionName = sysPermissionName;
        return this;
    }
    ...
    public SysPermission setSysPermissionDataUnsafe(String sysPermissionData) {
        this.sysPermissionData = sysPermissionData;
        return this;
    }
    ...
    public SysPermission setSysPermissionDescUnsafe(String sysPermissionDesc) {
        this.sysPermissionDesc = sysPermissionDesc;
        return this;
    }
