...
public class SysGroupPermission implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_group_permission_id",desc="",type="bigint")
    private Long sysGroupPermissionId;
    @EntityAttribute(key=false,size = 0,name="sys_group_permission_pid",desc="",type="bigint")
    private Long sysGroupPermissionPid;
    @EntityAttribute(key=false,size = 0,name="sys_group_permission_gid",desc="",type="bigint")
    private Long sysGroupPermissionGid;
    @EntityAttribute(key=false,size = 0,name="sys_group_permission_time",desc="",type="datetime")
   ...
   public SysGroupPermission() {}
    ...
    public Long getSysGroupPermissionId() {
        return sysGroupPermissionId;
    }
    public SysGroupPermission setSysGroupPermissionId(Long sysGroupPermissionId) {
        this.sysGroupPermissionId = sysGroupPermissionId;
        return this;
    }
    public Long getSysGroupPermissionPid() {
        return sysGroupPermissionPid;
    }
    public SysGroupPermission setSysGroupPermissionPid(Long sysGroupPermissionPid) {
        this.sysGroupPermissionPid = sysGroupPermissionPid;
        return this;
    }
    public Long getSysGroupPermissionGid() {
        return sysGroupPermissionGid;
    }
    public SysGroupPermission setSysGroupPermissionGid(Long sysGroupPermissionGid) {
