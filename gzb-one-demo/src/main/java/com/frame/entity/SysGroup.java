...
public class SysGroup implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_group_id",desc="权限组ID",type="bigint")
    private Long sysGroupId;
    @EntityAttribute(key=false,size = 255,name="sys_group_name",desc="权限组名称",type="varchar(255)")
    private String sysGroupName;
    @EntityAttribute(key=false,size = 0,name="sys_group_type",desc="权限组类型",type="bigint")
    private Long sysGroupType;
    @EntityAttribute(key=false,size = 255,name="sys_group_desc",desc="权限组描述",type="varchar(255)")
    private String sysGroupDesc;
    @EntityAttribute(key=false,size = 0,name="sys_group_sup",desc="权限组上级",type="bigint")
   ...
   public SysGroup() {}
    ...
    public SysGroup setSysGroupNameUnsafe(String sysGroupName) {
        this.sysGroupName = sysGroupName;
        return this;
    }
    ...
    public SysGroup setSysGroupDescUnsafe(String sysGroupDesc) {
        this.sysGroupDesc = sysGroupDesc;
        return this;
    }
