...
public class SysFile implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_file_id",desc="ID",type="bigint")
    private Long sysFileId;
    @EntityAttribute(key=false,size = 100,name="sys_file_path",desc="相对路径",type="varchar(100)")
    private String sysFilePath;
    @EntityAttribute(key=false,size = 64,name="sys_file_md5",desc="数据摘要",type="varchar(64)")
    private String sysFileMd5;
    @EntityAttribute(key=false,size = 0,name="sys_file_time",desc="上传时间",type="datetime")
    private java.time.LocalDateTime sysFileTime;
    @EntityAttribute(key=false,size = 100,name="sys_file_type",desc="文件类型",type="varchar(100)")
   ...
   public SysFile() {}
    ...
    public SysFile setSysFilePathUnsafe(String sysFilePath) {
        this.sysFilePath = sysFilePath;
        return this;
    }
    ...
    public SysFile setSysFileMd5Unsafe(String sysFileMd5) {
        this.sysFileMd5 = sysFileMd5;
        return this;
    }
    ...
    public SysFile setSysFileTypeUnsafe(String sysFileType) {
        this.sysFileType = sysFileType;
        return this;
    }
