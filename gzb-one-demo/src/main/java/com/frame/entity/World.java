...
public class World implements Serializable, JsonSerializable{
    ...
    private Integer worldRandomnumber;
    private Object data;
   public World() {}
    ...
    public World setWorldId(Integer worldId) {
        this.worldId = worldId;
        return this;
    }
    public Integer getWorldRandomnumber() {
        return worldRandomnumber;
    }
    public World setWorldRandomnumber(Integer worldRandomnumber) {
