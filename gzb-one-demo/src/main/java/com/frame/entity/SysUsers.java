...
public class SysUsers implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_users_id",desc="ID",type="bigint")
    private Long sysUsersId;
    @EntityAttribute(key=false,size = 32,name="sys_users_acc",desc="账号",type="varchar(32)")
    private String sysUsersAcc;
    @EntityAttribute(key=false,size = 32,name="sys_users_pwd",desc="密码",type="varchar(32)")
    private String sysUsersPwd;
    @EntityAttribute(key=false,size = 11,name="sys_users_phone",desc="手机",type="varchar(11)")
    private String sysUsersPhone;
    @EntityAttribute(key=false,size = 100,name="sys_users_open_id",desc="三方",type="varchar(100)")
    private String sysUsersOpenId;
    @EntityAttribute(key=false,size = 0,name="sys_users_status",desc="状态",type="bigint")
    private Long sysUsersStatus;
    @EntityAttribute(key=false,size = 0,name="sys_users_type",desc="类型",type="bigint")
    private Long sysUsersType;
    @EntityAttribute(key=false,size = 0,name="sys_users_reg_time",desc="注册",type="datetime")
    private java.time.LocalDateTime sysUsersRegTime;
    @EntityAttribute(key=false,size = 0,name="sys_users_start_time",desc="开始",type="datetime")
    private java.time.LocalDateTime sysUsersStartTime;
    @EntityAttribute(key=false,size = 0,name="sys_users_end_time",desc="结束",type="datetime")
    private java.time.LocalDateTime sysUsersEndTime;
    @EntityAttribute(key=false,size = 0,name="sys_users_price",desc="金额",type="bigint")
    private Long sysUsersPrice;
    @EntityAttribute(key=false,size = 255,name="sys_users_desc",desc="备注",type="varchar(255)")
    private String sysUsersDesc;
    @EntityAttribute(key=false,size = 0,name="sys_users_sup",desc="上级",type="bigint")
    private Long sysUsersSup;
    @EntityAttribute(key=false,size = 255,name="sys_users_mail",desc="邮箱",type="varchar(255)")
    private String sysUsersMail;
    @EntityAttribute(key=false,size = 0,name="sys_users_role",desc="角色",type="bigint")
   ...
   public SysUsers() {}
    ...
    public SysUsers setSysUsersAccUnsafe(String sysUsersAcc) {
        this.sysUsersAcc = sysUsersAcc;
        return this;
    }
    ...
    public SysUsers setSysUsersPwdUnsafe(String sysUsersPwd) {
        this.sysUsersPwd = sysUsersPwd;
        return this;
    }
    ...
    public SysUsers setSysUsersPhoneUnsafe(String sysUsersPhone) {
        this.sysUsersPhone = sysUsersPhone;
        return this;
    }
    ...
    public SysUsers setSysUsersOpenIdUnsafe(String sysUsersOpenId) {
        this.sysUsersOpenId = sysUsersOpenId;
        return this;
    }
    ...
    public SysUsers setSysUsersDescUnsafe(String sysUsersDesc) {
        this.sysUsersDesc = sysUsersDesc;
        return this;
    }
    ...
    public SysUsers setSysUsersMailUnsafe(String sysUsersMail) {
        this.sysUsersMail = sysUsersMail;
        return this;
    }
