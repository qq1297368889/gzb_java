...
public class SysOptionRequest implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_option_request_id",desc="",type="bigint")
    private Long sysOptionRequestId;
    @EntityAttribute(key=false,size = 100,name="sys_option_request_url",desc="请求地址",type="varchar(100)")
    private String sysOptionRequestUrl;
    @EntityAttribute(key=false,size = 10,name="sys_option_request_met",desc="请求方式",type="varchar(10)")
    private String sysOptionRequestMet;
    @EntityAttribute(key=false,size = 255,name="sys_option_request_data",desc="请求参数",type="varchar(255)")
    private String sysOptionRequestData;
    @EntityAttribute(key=false,size = 100,name="sys_option_request_title_name",desc="标题键名",type="varchar(100)")
    private String sysOptionRequestTitleName;
    @EntityAttribute(key=false,size = 100,name="sys_option_request_val_name",desc="内容键名",type="varchar(100)")
    private String sysOptionRequestValName;
    @EntityAttribute(key=false,size = 255,name="sys_option_request_search_url",desc="搜索请求地址",type="varchar(255)")
    private String sysOptionRequestSearchUrl;
    @EntityAttribute(key=false,size = 255,name="sys_option_request_search_met",desc="搜索请求方式",type="varchar(255)")
    private String sysOptionRequestSearchMet;
    @EntityAttribute(key=false,size = 255,name="sys_option_request_search_data",desc="搜索请求参数",type="varchar(255)")
    private String sysOptionRequestSearchData;
    @EntityAttribute(key=false,size = 255,name="sys_option_request_search_title_name",desc="搜索标题键名",type="varchar(255)")
    private String sysOptionRequestSearchTitleName;
    @EntityAttribute(key=false,size = 255,name="sys_option_request_search_val_name",desc="搜索内容键名",type="varchar(255)")
    private String sysOptionRequestSearchValName;
    @EntityAttribute(key=false,size = 100,name="sys_option_request_key",desc="助记名称",type="varchar(100)")
   ...
   public SysOptionRequest() {}
    ...
    public SysOptionRequest setSysOptionRequestUrlUnsafe(String sysOptionRequestUrl) {
        this.sysOptionRequestUrl = sysOptionRequestUrl;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestMetUnsafe(String sysOptionRequestMet) {
        this.sysOptionRequestMet = sysOptionRequestMet;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestDataUnsafe(String sysOptionRequestData) {
        this.sysOptionRequestData = sysOptionRequestData;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestTitleNameUnsafe(String sysOptionRequestTitleName) {
        this.sysOptionRequestTitleName = sysOptionRequestTitleName;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestValNameUnsafe(String sysOptionRequestValName) {
        this.sysOptionRequestValName = sysOptionRequestValName;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestSearchUrlUnsafe(String sysOptionRequestSearchUrl) {
        this.sysOptionRequestSearchUrl = sysOptionRequestSearchUrl;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestSearchMetUnsafe(String sysOptionRequestSearchMet) {
        this.sysOptionRequestSearchMet = sysOptionRequestSearchMet;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestSearchDataUnsafe(String sysOptionRequestSearchData) {
        this.sysOptionRequestSearchData = sysOptionRequestSearchData;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestSearchTitleNameUnsafe(String sysOptionRequestSearchTitleName) {
        this.sysOptionRequestSearchTitleName = sysOptionRequestSearchTitleName;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestSearchValNameUnsafe(String sysOptionRequestSearchValName) {
        this.sysOptionRequestSearchValName = sysOptionRequestSearchValName;
        return this;
    }
    ...
    public SysOptionRequest setSysOptionRequestKeyUnsafe(String sysOptionRequestKey) {
        this.sysOptionRequestKey = sysOptionRequestKey;
        return this;
    }
