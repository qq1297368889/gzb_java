...
public class SysMappingTable implements Serializable, JsonSerializable{
    ...
    @EntityAttribute(key=true,size = 0,name="sys_mapping_table_id",desc="",type="bigint")
    private Long sysMappingTableId;
    @EntityAttribute(key=false,size = 255,name="sys_mapping_table_name",desc="",type="varchar(255)")
    private String sysMappingTableName;
    @EntityAttribute(key=false,size = 255,name="sys_mapping_table_title",desc="",type="varchar(255)")
   ...
   public SysMappingTable() {}
    ...
    public SysMappingTable setSysMappingTableNameUnsafe(String sysMappingTableName) {
        this.sysMappingTableName = sysMappingTableName;
        return this;
    }
    ...
    public SysMappingTable setSysMappingTableTitleUnsafe(String sysMappingTableTitle) {
        this.sysMappingTableTitle = sysMappingTableTitle;
        return this;
    }
