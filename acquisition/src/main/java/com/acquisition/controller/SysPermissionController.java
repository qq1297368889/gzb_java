...
import com.acquisition.dao.SysPermissionDao;
...
@Controller
@RequestMapping(value = "/system/v1.0.0/sysPermission", header = "content-type:application/json;charset=UTF-8")
public class SysPermissionController{
    @Resource(value = "com.acquisition.dao.impl.SysPermissionDaoImpl")
    ...
    public Object find(JSONResult result, SysPermission sysPermission) throws Exception {
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(JSONResult result,SysPermission sysPermission, String sortField, String sortType, Integer page, Integer size) throws Exception {
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(JSONResult result, SysPermission sysPermission) throws Exception {
        if (sysPermission == null || sysPermission.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(JSONResult result, SysPermission sysPermission) throws Exception {
    ...
    public Object delete(JSONResult result, SysPermission sysPermission) throws Exception {
        if (sysPermission == null || sysPermission.toString().equals("{}") || sysPermission.getSysPermissionId() == null) {
    ...
    public Object deleteAll(JSONResult result, Long[] sysPermissionId) throws Exception {
        if (sysPermissionId == null || sysPermissionId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num=0;
        SysPermission acquisition = new SysPermission();
        for (Long aLong : sysPermissionId) {
            sysPermissionDao.delete(acquisition.setSysPermissionId(aLong));num++;
        }
