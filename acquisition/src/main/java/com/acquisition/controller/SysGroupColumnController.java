...
import com.acquisition.entity.SysGroupColumn;
import com.acquisition.dao.SysGroupColumnDao;
...
@Controller
@RequestMapping(value = "/system/v1.0.0/sysGroupColumn", header = "content-type:application/json;charset=UTF-8")
public class SysGroupColumnController{
    @Resource(value = "com.acquisition.dao.impl.SysGroupColumnDaoImpl")
    ...
    public Object find(JSONResult result, SysGroupColumn sysGroupColumn) throws Exception {
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(JSONResult result,SysGroupColumn sysGroupColumn, String sortField, String sortType, Integer page, Integer size) throws Exception {
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(JSONResult result, SysGroupColumn sysGroupColumn) throws Exception {
        if (sysGroupColumn == null || sysGroupColumn.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(JSONResult result, SysGroupColumn sysGroupColumn) throws Exception {
    ...
    public Object delete(JSONResult result, SysGroupColumn sysGroupColumn) throws Exception {
        if (sysGroupColumn == null || sysGroupColumn.toString().equals("{}") || sysGroupColumn.getSysGroupColumnId() == null) {
    ...
    public Object deleteAll(JSONResult result, Long[] sysGroupColumnId) throws Exception {
        if (sysGroupColumnId == null || sysGroupColumnId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num=0;
        SysGroupColumn acquisition = new SysGroupColumn();
        for (Long aLong : sysGroupColumnId) {
            sysGroupColumnDao.delete(acquisition.setSysGroupColumnId(aLong));num++;
        }
