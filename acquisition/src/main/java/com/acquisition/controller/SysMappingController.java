...
import com.acquisition.entity.SysMapping;
...
@Controller
@RequestMapping(value = "/system/v1.0.0/sysMapping", header = "content-type:application/json;charset=UTF-8")
public class SysMappingController{
    @Resource(value = "com.acquisition.dao.impl.SysMappingDaoImpl")
    ...
    public Object find(JSONResult result, SysMapping sysMapping) throws Exception {
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(JSONResult result,SysMapping sysMapping, String sortField, String sortType, Integer page, Integer size) throws Exception {
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(JSONResult result, SysMapping sysMapping) throws Exception {
        if (sysMapping == null || sysMapping.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(JSONResult result, SysMapping sysMapping) throws Exception {
    ...
    public Object delete(JSONResult result, SysMapping sysMapping) throws Exception {
        if (sysMapping == null || sysMapping.toString().equals("{}") || sysMapping.getSysMappingId() == null) {
    ...
    public Object deleteAll(JSONResult result, Long[] sysMappingId) throws Exception {
        if (sysMappingId == null || sysMappingId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num=0;
        SysMapping acquisition = new SysMapping();
        for (Long aLong : sysMappingId) {
            sysMappingDao.delete(acquisition.setSysMappingId(aLong));num++;
        }
