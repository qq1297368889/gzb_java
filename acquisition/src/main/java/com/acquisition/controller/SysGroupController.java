...
import com.acquisition.entity.SysGroup;
import com.acquisition.dao.SysGroupDao;
...
@Controller
@RequestMapping(value = "/system/v1.0.0/sysGroup", header = "content-type:application/json;charset=UTF-8")
public class SysGroupController{
    @Resource(value = "com.acquisition.dao.impl.SysGroupDaoImpl")
    ...
    public Object find(JSONResult result, SysGroup sysGroup) throws Exception {
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(JSONResult result,SysGroup sysGroup, String sortField, String sortType, Integer page, Integer size) throws Exception {
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(JSONResult result, SysGroup sysGroup) throws Exception {
        if (sysGroup == null || sysGroup.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(JSONResult result, SysGroup sysGroup) throws Exception {
    ...
    public Object delete(JSONResult result, SysGroup sysGroup) throws Exception {
        if (sysGroup == null || sysGroup.toString().equals("{}") || sysGroup.getSysGroupId() == null) {
    ...
    public Object deleteAll(JSONResult result, Long[] sysGroupId) throws Exception {
        if (sysGroupId == null || sysGroupId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num=0;
        SysGroup acquisition = new SysGroup();
        for (Long aLong : sysGroupId) {
            sysGroupDao.delete(acquisition.setSysGroupId(aLong));num++;
        }
