...
import com.acquisition.entity.SysFile;
import com.acquisition.dao.SysFileDao;
...
@Controller
@RequestMapping(value = "/system/v1.0.0/sysFile", header = "content-type:application/json;charset=UTF-8")
public class SysFileController{
    @Resource(value = "com.acquisition.dao.impl.SysFileDaoImpl")
    ...
    public Object find(JSONResult result, SysFile sysFile) throws Exception {
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(JSONResult result,SysFile sysFile, String sortField, String sortType, Integer page, Integer size) throws Exception {
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(JSONResult result, SysFile sysFile) throws Exception {
        if (sysFile == null || sysFile.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(JSONResult result, SysFile sysFile) throws Exception {
    ...
    public Object delete(JSONResult result, SysFile sysFile) throws Exception {
        if (sysFile == null || sysFile.toString().equals("{}") || sysFile.getSysFileId() == null) {
    ...
    public Object deleteAll(JSONResult result, Long[] sysFileId) throws Exception {
        if (sysFileId == null || sysFileId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num=0;
        SysFile acquisition = new SysFile();
        for (Long aLong : sysFileId) {
            sysFileDao.delete(acquisition.setSysFileId(aLong));num++;
        }
