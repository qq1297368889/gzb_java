...
import com.acquisition.entity.SysUsersLoginLog;
...
@Controller
@RequestMapping(value = "/system/v1.0.0/sysUsersLoginLog", header = "content-type:application/json;charset=UTF-8")
public class SysUsersLoginLogController{
    @Resource(value = "com.acquisition.dao.impl.SysUsersLoginLogDaoImpl")
    ...
    public Object find(JSONResult result, SysUsersLoginLog sysUsersLoginLog) throws Exception {
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(JSONResult result,SysUsersLoginLog sysUsersLoginLog, String sortField, String sortType, Integer page, Integer size) throws Exception {
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(JSONResult result, SysUsersLoginLog sysUsersLoginLog) throws Exception {
        if (sysUsersLoginLog == null || sysUsersLoginLog.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(JSONResult result, SysUsersLoginLog sysUsersLoginLog) throws Exception {
    ...
    public Object delete(JSONResult result, SysUsersLoginLog sysUsersLoginLog) throws Exception {
        if (sysUsersLoginLog == null || sysUsersLoginLog.toString().equals("{}") || sysUsersLoginLog.getSysUsersLoginLogId() == null) {
    ...
    public Object deleteAll(JSONResult result, Long[] sysUsersLoginLogId) throws Exception {
        if (sysUsersLoginLogId == null || sysUsersLoginLogId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num=0;
        SysUsersLoginLog acquisition = new SysUsersLoginLog();
        for (Long aLong : sysUsersLoginLogId) {
            sysUsersLoginLogDao.delete(acquisition.setSysUsersLoginLogId(aLong));num++;
        }
