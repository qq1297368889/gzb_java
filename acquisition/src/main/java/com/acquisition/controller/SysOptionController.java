...
import com.acquisition.entity.SysOption;
...
@Controller
@RequestMapping(value = "/system/v1.0.0/sysOption", header = "content-type:application/json;charset=UTF-8")
public class SysOptionController{
    @Resource(value = "com.acquisition.dao.impl.SysOptionDaoImpl")
    ...
    public Object find(JSONResult result, SysOption sysOption) throws Exception {
    ...
    @DecoratorOpen
    @GetMapping("list")
    public Object list(JSONResult result,SysOption sysOption, String sortField, String sortType, Integer page, Integer size) throws Exception {
    ...
    @DecoratorOpen
    @PostMapping("save")
    public Object save(JSONResult result, SysOption sysOption) throws Exception {
        if (sysOption == null || sysOption.toString().equals("{}")) {
    ...
    @DecoratorOpen
    @PostMapping("update")
    public Object update(JSONResult result, SysOption sysOption) throws Exception {
    ...
    public Object delete(JSONResult result, SysOption sysOption) throws Exception {
        if (sysOption == null || sysOption.toString().equals("{}") || sysOption.getSysOptionId() == null) {
    ...
    public Object deleteAll(JSONResult result, Long[] sysOptionId) throws Exception {
        if (sysOptionId == null || sysOptionId.length < 1) {
            return result.fail("delete 输入参数错误");
        }
        int num=0;
        SysOption acquisition = new SysOption();
        for (Long aLong : sysOptionId) {
            sysOptionDao.delete(acquisition.setSysOptionId(aLong));num++;
        }
