...
/*
    ...
    public static SqlTemplate toSaveSql(Object object, DataBase dataBase, boolean reset, int sql_type) {
        GzbEntityInterface gzbEntityInterface = readObject(object.getClass());
        if (gzbEntityInterface == null) {
            return null;
        }
    ...
    public static <T> T loadResultSet(Class<?> aClass, java.sql.ResultSet resultSet, Set<String> names) {
        GzbEntityInterface gzbEntityInterface = readObject(aClass);
        if (gzbEntityInterface == null) {
            return null;
        }
    ...
    public static <T> T loadResultSet(Class<?> aClass, Row row, Set<String> names) {
        GzbEntityInterface gzbEntityInterface = readObject(aClass);
        if (gzbEntityInterface == null) {
            return null;
        }
    ...
    public static <T> List<T> loadResultSet(Class<?> aClass, RowSet<Row> rowSet) {
        GzbEntityInterface gzbEntityInterface = readObject(aClass);
        if (gzbEntityInterface == null) {
            return null;
        }
